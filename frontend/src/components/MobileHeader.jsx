            ...
            <div className="px-4 h-16 flex items-center gap-4">
                ...
                <form onSubmit={handleSearch} className="flex-1 relative">
                    <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-2 pl-4 pr-10 text-sm font-medium text-white placeholder:text-white/20 focus:ring-2 focus:ring-[#991b1b]/30 focus:border-[#991b1b]/50 transition-all"
                    />
                ...
                {/* Cart Icon in Header too for visibility */}
