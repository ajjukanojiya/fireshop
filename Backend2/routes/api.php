...
// UNIVERSAL ROUTING: Support both Local (/api/v1) and Server (/v1) through subpath
// Unique names are provided to 'name()' to avoid Artisan 'products.index' collision errors.
$prefixes = ['v1', 'api/v1'];

foreach ($prefixes as $p) {
    $routeNamePrefix = str_replace('/', '_', $p) . '.';

    Route::prefix($p)->name($routeNamePrefix)->group(function () {
